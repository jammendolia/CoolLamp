...
test('microphone variants keep existing IDs and expose audio only in the advertised catalog', () => {
  ...
  const audio=validateCatalog([...base,{id:39,name:'Sound glow',category:'audio',speed:true},
    {id:40,name:'Sound meter',category:'audio',speed:true},...['Spectrum Rise','Bass Launch','Spectral Embers','Beat Bloom','Three-band Fountain'].map((name,i)=>({id:41+i,name,category:'audio',speed:true}))],45);
